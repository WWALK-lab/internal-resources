...
Through our science and all that surrounds it, we strive to recognize and dismantle the systemic barriers placed upon marginalized people and to create a space where we/they can thrive. "Scientist" is a role comprised of many parts which cannot be isolated from each other, the parts include mentor, community member, statistician, communicator, advocate, writer, teacher, and more. The policies contained in this document encompass all of the roles we play.
...
As head of the WWALK Lab, Ally is the community leader in charge of handling issues regarding breaches in the code of conduct. You can report any issue to Ally and all communication will be treated as confidential. If the issue you have includes Ally, you can report it to the Graduate Program Director, Paul Galpern (paul.galpern@ucalgary.ca). 
